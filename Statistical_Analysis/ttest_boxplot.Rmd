...
p = gridExtra::grid.arrange(RU_boxplot1, RU_boxplot2, ncol = 2,
                        left = "Exposure Risk",
                        top = "COVID-19 Exposure Risk during Phase 2 in Rural and Urban Illinois") 
ggsave( "/Users/zhangyuqi/Desktop/test/exposure/COVID-19 Exposure Risk during Phase 2 in Rural and Urban Illinois.png", plot = p)
```
